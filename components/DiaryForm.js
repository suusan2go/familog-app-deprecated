...
import { Text, TextInput, ListView, View, Image, StyleSheet, ScrollView, findNodeHandle } from 'react-native';
  ...
  render(){
    return(
      <KeyboardAwareScrollView>
        <Field label="タイトル" fieldValue={this.state.title} onChange={(text) => this.setState({ title: text})} />
        <Field
          label="本文"
